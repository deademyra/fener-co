    ...
    <div className="card p-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        <div className="bg-gray-800/50 rounded-lg p-4 text-center">
          <p className="text-3xl font-display text-fb-yellow">{finishedMatches.length}</p>
          <p className="text-xs text-gray-500">Maç</p>
        </div>
        <div className="bg-gray-800/50 rounded-lg p-4 text-center">
          <p className="text-3xl font-display text-white">{points}</p>
          <p className="text-xs text-gray-500">Puan</p>
        </div>
        <div className="bg-gray-800/50 rounded-lg p-4 text-center">
          <p className="text-3xl font-display text-green-400">{wins}</p>
          <p className="text-xs text-gray-500">Galibiyet</p>
        </div>
        <div className="bg-gray-800/50 rounded-lg p-4 text-center">
          <p className="text-3xl font-display text-fb-yellow">{goalsFor}</p>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="text-center">
          <p className="text-xl font-display text-gray-400">{draws}</p>
          <p className="text-xs text-gray-500">Beraberlik</p>
        </div>
        <div className="text-center">
          <p className="text-xl font-display text-red-400">{losses}</p>
          <p className="text-xs text-gray-500">Mağlubiyet</p>
        </div>
        <div className="text-center">
          <p className="text-xl font-display text-red-400">{goalsAgainst}</p>
          <p className="text-xs text-gray-500">Yenen Gol</p>
        </div>
        <div className="text-center">
          <p className="text-xl font-display text-green-400">{cleanSheets}</p>
      ...
      <div className="mt-6 pt-6 border-t border-gray-800">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
          <div>
            ...
            <p className="text-lg font-display text-fb-yellow">{avgGoalsFor}</p>
          </div>
          <div>
            <p className="text-sm text-gray-500">Yenilen Gol Ort.</p>
            <p className="text-lg font-display text-gray-400">{avgGoalsAgainst}</p>
          </div>
          <div>
            <p className="text-sm text-gray-500">İç Saha Galibiyet</p>
            <p className="text-lg font-display text-green-400">{homeWins}</p>
          </div>
          <div>
            <p className="text-sm text-gray-500">Deplasman Galibiyet</p>
            <p className="text-lg font-display text-green-400">{awayWins}</p>
          </div>
        </div>
      </div>
    </div>
